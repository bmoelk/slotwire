 ...
 */
export function createContentTicket(options) {
    const { description, severity = 'medium', status = 'open', context, stagingBaseUrl = 'https://staging.example.com', adminUrl = 'https://cms.example.com/admin', reporterEmail, } = options;
 ...
 */
export async function dispatchTicket(ticket, options) {
    const errors = [];
 ...
 */
export function generateBookmarkletCode(options = {}) {
    const { adminUrl = 'https://cms.example.com/admin', stagingUrl = 'https://staging.example.com', } = options;
    const script = `
(function(){
