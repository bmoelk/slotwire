...
export interface AstroLoaderContext {
  ...
  parseData?: (entry: { id: string; data: Record<string, any> }) => Promise<any> | any;
 ...
 */
export function slotwireLoader(options: SlotwireLoaderOptions) {
