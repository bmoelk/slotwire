...
export function isDevOrPreview() {
    ...
    if (params.get('slotwire_preview') === 'true' ||
...
export function syncStaticSlotBadges(active) {
...
export function setSlotHighlight(active) {
    if (typeof document === 'undefined')
        return;
    if (active) {
...
export function injectHighlightStyles() {
    if (typeof document === 'undefined' || document.getElementById('slotwire-highlight-styles'))
        return;
...
export function setupHighlightKeyboardShortcut() {
    if (typeof window === 'undefined' || window.__slotwire_keyboard_bound)
        return;
    window.__slotwire_keyboard_bound = true;
...
//# sourceMappingURL=slot-highlight.js.map