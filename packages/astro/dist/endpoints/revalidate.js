...
function verifySignature(rawBody, headers, secret) {
    ...
    const signatureHeader = headers.get('x-slotwire-signature') ||
 ...
 */
export async function handleRevalidateRequest(request, options = {}) {
    ...
    const secret = options.webhookSecret ||
        config?.sync?.webhookSecret ||
        config?.preview?.secret ||
 ...
 */
export function createRevalidateEndpoint(options = {}) {
