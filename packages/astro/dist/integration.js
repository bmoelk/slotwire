...
export function slotwire(options) {
    return {
        name: 'astro-slotwire',
        hooks: {
            'astro:config:setup': async ({ config, addDevToolbarApp, updateConfig, injectRoute, isRestart }) => {
                globalThis.__SLOTWIRE_CONFIG__ = options.config;
                if (!isRestart) {
