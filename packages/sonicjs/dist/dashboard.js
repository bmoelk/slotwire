...
export function renderSlotWireDashboard(options) {
    const { config, stagingUrl = 'https://staging.example.com', productionUrl = 'https://example.com', embedded = true, } = options;
